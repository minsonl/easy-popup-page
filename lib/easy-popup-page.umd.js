(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["easy-popup-page"] = factory();
	else
		root["easy-popup-page"] = factory();
...
// Module
exports.push([module.i, "body,html{width:100%;height:100%}body{position:relative}.bounce-enter-active{-webkit-animation:bounce-in .2s;animation:bounce-in .2s}.bounce-leave-active{animation:bounce-in .2s reverse}@-webkit-keyframes bounce-in{0%{opacity:.2;-webkit-transform:scale(.9);transform:scale(.9)}50%{-webkit-transform:scale(1.05);transform:scale(1.05)}to{opacity:1;-webkit-transform:scale(1);transform:scale(1)}}@keyframes bounce-in{0%{opacity:.2;-webkit-transform:scale(.9);transform:scale(.9)}50%{-webkit-transform:scale(1.05);transform:scale(1.05)}to{opacity:1;-webkit-transform:scale(1);transform:scale(1)}}.epp-container{width:100px;height:100px;position:fixed;background-color:#fff;border-radius:2px;border:1px solid rgba(0,0,0,.1);-webkit-box-shadow:1px 1px 5px rgba(0,0,0,.2);box-shadow:1px 1px 5px rgba(0,0,0,.2)}.epp-title{width:100%;height:40px;position:absolute;top:0;left:0;background-color:#f8f8f8;border-radius:2px 2px 0 0;border-bottom:1px solid #eee;-webkit-box-sizing:border-box;box-sizing:border-box;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.epp-title .tit-left{line-height:40px;float:left;font-size:14px;color:#333;padding:0 10px}.epp-title .tit-right{float:right;font-size:30px;line-height:40px;color:#444;cursor:pointer;padding:0 5px;margin-top:-2px;-o-transform:rotate(45deg);-moz-transform:rotate(45deg);-webkit-transform:rotate(45deg);-ms-transform:rotate(45deg)}.epp-title .tit-right:hover{color:#888}.epp-title .tit-right:active{color:#333}.epp-content{width:100%;height:100%;border-top:40px solid #f8f8f8;-webkit-box-sizing:border-box;box-sizing:border-box;overflow-x:hidden;overflow-y:hidden}.epp-content.scroll-x{overflow-x:scroll}.epp-content.scroll-y{overflow-y:scroll}.epp-scale{width:10px;height:10px;overflow:hidden;cursor:se-resize;position:absolute;right:0;bottom:0}", ""]);
...
// load the styles
var content = __webpack_require__("105d");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("8c34d186", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"6e91d8f4-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/src/main.vue?vue&type=template&id=51ecaf66&
var render = function () {
var this$1 = this;
var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"name":"bounce"}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.isShow),expression:"isShow"}],ref:"eppContainer",staticClass:"epp-container",style:({ 'z-index':_vm.zIndex  }),attrs:{"id":_vm.page_id},on:{"mousedown":function($event){return _vm.containerMouseDown($event)}}},[_c('div',{staticClass:"epp-title",on:{"mousedown":function($event){return _vm.titleMouseDown($event)}}},[_c('div',{staticClass:"tit-left"},[_vm._v(_vm._s(_vm.title))]),_c('div',{staticClass:"tit-right",on:{"click":_vm.destroyElement}},[_vm._v("+")])]),_c('div',{staticClass:"epp-content",class:{'scroll-x':_vm.scrollX,'scroll-y':_vm.scrollY}},[(_vm.isload)?[_c(_vm.component,{tag:"component",attrs:{"param":_vm.param,"page_id":_vm.page_id},on:{"setTitle":function (tit){this$1.title = tit}}})]:_vm._e()],2),_c('div',{ref:"scale",staticClass:"epp-scale",on:{"mousedown":function($event){return _vm.scaleMouseDown($event)}}})])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./packages/src/main.vue?vue&type=template&id=51ecaf66&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/src/main.vue?vue&type=script&lang=js&
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  methods: {
    init: function init() {
      this.isShow = true;
      var box = this.$refs.eppContainer;
    ...
    containerMouseDown: function containerMouseDown(e) {
      var num = 0;
      var store = this.$epp.store;
    ...
    titleMouseDown: function titleMouseDown(event) {
      if (!this.isMove) {
        return;
      }

      var fa = document.body;
      var box = this.$refs.eppContainer;
      ...
      window.onmousemove = function (e) {
        ...
        var y = e.clientY - disY; // 图形移动的边界判断
    ...
    scaleMouseDown: function scaleMouseDown(event) {
      var _this2 = this;
      ...
      window.onmousemove = function (e) {
        e.preventDefault(); // 设置最小宽高

        var w = Math.max(_this2.minWidth, e.clientX - pos.x + pos.w);
        var h = Math.max(_this2.minHeight, e.clientY - pos.y + pos.h); // 设置最大宽高
    ...
    createdIndex: function createdIndex() {
      var maxIndex = _toConsumableArray(document.all).reduce(function (r, e) {
...
// CONCATENATED MODULE: ./packages/src/main.vue?vue&type=script&lang=js&
 /* harmony default export */ var src_mainvue_type_script_lang_js_ = (mainvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./packages/src/main.vue?vue&type=style&index=0&lang=css&
var mainvue_type_style_index_0_lang_css_ = __webpack_require__("f517");
...
// CONCATENATED MODULE: ./packages/src/main.vue
  ...
  install: function install(Vue) {
    Vue.prototype.$epp = {
      ...
      open: function open(name) {
        ...
        var openCb = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : function () {};

        if (!this.store.hasOwnProperty(name)) {
          //不存在name
          this.error("popuPage '".concat(name, "' not exist!"));
          return;
        }

        var storeTarget = this.store[name];
        ...
        var construct = Vue.extend(main);
        storeTarget.instance = new construct({
          propsData: _objectSpread({}, storeTarget.options, {
            param: param,
            page_id: 'epp_' + storeTarget.options.name
          })
        });
        storeTarget.instance.$on("close", function () {
          _this.close(name);
        });
